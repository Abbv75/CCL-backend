...
class TournoiController extends Controller
{
    ...
    {
        try {
            $tournois = Tournoi::with('participants', 'parties', 'status', 'gagnant')->get();
    ...
    {
        try {
            $tournoi = Tournoi::with('participants', 'parties', 'status', 'gagnant')->find($id);
    ...
    public function addParticipants(Request $request, $idTournoi)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'data' => $tournoi->load('participants', 'parties', 'status', 'gagnant')
            ]);
        } catch (\Throwable $th) {
            return response()->json([
